...
$$Y_i \in [0,1]$$      
$$i \in [1,8]$$
Currently, we do not have knowledge regarding the inventory management solution implemented by the company.Hence, we considered lot for lot as a base inventory management model to do a cost benefit analysis of Integer linear programming method.
